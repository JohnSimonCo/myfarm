...
var delavalCan = {
	...
	Can: function( container, milkData, allImage, perm ) {
		var
		image,
		onresize,
		currentCan,
		...
		totImg=3,
		imageMan = jr.ec( new Image(), { src: '/Delaval/Resources/Mode_Manual.png', onload: checkImageLoad} ),
		imageAuto = jr.ec( new Image(), { src: '/Delaval/Resources/Mode_Auto.png', onload: checkImageLoad} ),
		image = jr.ec( new Image(), { src: '/Delaval/Resources/can1.png', onload: checkImageLoad} ),
		robotModeActive=0,
		selectedCan=0;
